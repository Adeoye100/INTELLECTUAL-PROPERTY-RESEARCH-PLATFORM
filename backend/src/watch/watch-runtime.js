...
export function createWatchRuntime({ config, redisClient, watchRepository, searchService, clock } = {}) {
  ...
  const processor = new WatchIngestProcessor({ watchRepository, queue, searchService, clock });
