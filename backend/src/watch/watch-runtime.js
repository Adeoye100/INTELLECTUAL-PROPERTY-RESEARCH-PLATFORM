...
export function createWatchRuntime({ config, redisClient, watchRepository, searchService, alertGenerationService, alertDeliveryService = null, clock } = {}) {
  ...
  const processor = new WatchIngestProcessor({
    repository: watchRepository, queue, searchService, alertGenerationService, alertDeliveryService, clock,
  });
